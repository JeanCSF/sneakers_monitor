        ...
        <div className="w-full p-4">
            <div className="bg-white dark:bg-gray-800 rounded-md shadow-md">
                <img
                    ...
                    onClick={() => navigate(`/sneaker/${sneaker._id}`)}
                />
                <div className="p-4">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mb-2 flex justify-between items-center">
                        <span className="overflow-hidden whitespace-nowrap overflow-ellipsis max-w-[100px] cursor-pointer" onClick={() => navigate(`/loja/${sneaker.store.toLowerCase()}`)}>{sneaker.store}</span>
